...
-- 🛡️ Anti-AFK (prevents kick for 20 min idle)
pcall(function()
...
-- 🔁 Constant TP to Sasuke every 0.5s
task.spawn(function()
    while autoFarm do
        pcall(function()
...
-- ⏳ Wait for Sasuke to spawn (just return root)
...
print("✅ Auto Sasuke Farm with Anti-AFK + TP (0.5s) started.")